...
public class SquareArea: UIView, SquareAreaProtocol {
    ...
    required public init(size: CGSize, color: UIColor) {
        //создание обработчика столкновеий
        ...
        //указываем границы прямоугольной области, как объекты взаимодействия,
        //чтобы шарики об них ударялись
        ...
        //подключаем к оператору обработчик столкновений
    ...
    public func setBalls(withColors ballsColor: [UIColor], andRadius radius: Int) {
        ...
        for (index, oneBallColor) in ballsColor.enumerated() {
            ...
            //добавляем шарик в текущее отображение (в прямоугольник)
